...
HD_PWD='/home/golfit/git/rp/rp-ttl-gen/rp-ttl-gen/rp-ttl-gen.runs/system_xlconcat_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_xlconcat_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_xlconcat_1_0.tcl
