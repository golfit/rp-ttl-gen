...
proc create_ipi_design { offsetfile design_name } {
	...
	set ttl_gen_axi_0 [ create_bd_cell -type ip -vlnv user.org:user:ttl_gen_axi:1.0 ttl_gen_axi_0 ]
	...
	# Copy all address to ttl_gen_axi_v1_0_include.tcl file
	set bd_path [get_property DIRECTORY [current_project]]/[current_project].srcs/[current_fileset]/bd
	upvar 1 $offsetfile offset_file
	set offset_file "${bd_path}/ttl_gen_axi_v1_0_include.tcl"
...
set ip_path [file dirname [file normalize [get_property XML_FILE_NAME [ipx::get_cores user.org:user:ttl_gen_axi:1.0]]]]
set hw_test_file ${ip_path}/example_designs/debug_hw_design/ttl_gen_axi_v1_0_hw_test.tcl
...
for { set i 1 } { 1 } { incr i } {
	set design_name "ttl_gen_axi_v1_0_hw_${i}"
